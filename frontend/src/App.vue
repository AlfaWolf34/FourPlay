    ...
    <header v-if="isAuthenticated" class="site-header">
      ...
      <nav class="navbar">
        ...
        <div class="nav-links">
          ...
          <router-link v-if="canViewAdminSections" to="/calendario" class="nav-link"
            :class="{ active: isActive('/calendario') }">

            CALENDARIO
          </router-link>
          <router-link v-if="canViewAdminSections" to="/estadisticas" class="nav-link"
        ...
        <div class="user-menu" @click="dropdownOpen = !dropdownOpen">
          <div class="user-pill">
            ...
            <svg class="chevron" :class="{ rotated: dropdownOpen }" width="14" height="14" viewBox="0 0 24 24"
